const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Or try the cloud version of FoxAI with free quote',
  },
  overview: {
    title: 'Overview',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Helps visitors understand the data the application collects, see FoxAI\'s <privacyPolicyLink>Privacy Policy</privacyPolicyLink>.',
        },
      },
      embedded: {
        entry: 'Embedded',
      ...
      customize: {
        ...
        way1: {
          name: 'Fork the client code, moFoxAI it and deploy to Vercel (recommended)',
          step1: 'Fork the client code and moFoxAI it',
          step1Tip: 'Click here to fork the source code into your GitHub account and moFoxAI the code',
          step1Operation: 'FoxAI-WebClient',
