const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'FoxAI account',
    langGeniusAccountTip: 'Your FoxAI account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to FoxAI to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by FoxAI allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  about: {
    ...
    nowAvailable: 'FoxAI {{version}} is now available.',
    latestAvailable: 'FoxAI {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Overview',
