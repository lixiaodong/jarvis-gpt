const translation = {
  ...
  welcome: 'Welcome to FoxAI, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting FoxAI Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on FoxAI',
  invalid: 'The link has expired',
  explore: 'Explore FoxAI',
