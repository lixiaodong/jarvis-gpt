const translation = {
  ...
  desc: 'Here you can moFoxAI the properties and working methods of the dataset.',
  form: {
    name: 'Dataset Name',
    nameError: 'Name cannot be empty',
    desc: 'Dataset description',
    descPlaceholder: 'Describe what is in this data set. A detailed description allows AI to access the content of the data set in a timely manner. If empty, FoxAI will use the default hit strategy.',
