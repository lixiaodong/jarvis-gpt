            ...
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ...
                  : <>
                    <Link href={locale === 'en' ? 'https://docs.jettylee.com/user-agreement/privacy-policy' : 'https://docs.jettylee.com/v/zh-hans/yong-hu-xie-yi/yin-si-xie-yi'} target='_blank'>Privacy Policy</Link>,
                    <Link href={locale === 'en' ? 'https://docs.jettylee.com/user-agreement/terms-of-service' : 'https://docs.jettylee.com/v/zh-hans/yong-hu-xie-yi/fu-wu-xie-yi'} target='_blank'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
